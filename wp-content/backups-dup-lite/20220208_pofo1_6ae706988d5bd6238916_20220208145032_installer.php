...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220208_pofo1_6ae706988d5bd6238916_20220208145032_archive.zip';
	const ARCHIVE_SIZE		 = '81470395';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6ae7069-08145032';
    const SECONDARY_PACKAGE_HASH = 'c14582e-08145032';
	const VERSION			 = '1.4.4';
